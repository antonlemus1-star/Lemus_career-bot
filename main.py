...
async def cmd_search(message: types.Message):
    ...
    r = requests.get(url, params={"text": query, "area": "1", "items_on_page": "20"}, headers={"User-Agent": "Mozilla/5.0"})
    ...
    await message.answer(f"🔥 Нашел позиций по запросу «{query}»: {len(items)}")
